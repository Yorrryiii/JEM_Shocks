        ...
        return (
            ...
            <div id='cuerpo'>
                ...
                <table class="tg">
                    <thead>
                        <tr>
                            <th class="title" colspan="5"><h4 id='titulo1'>Our <span id='titulo2'>Partners</span></h4></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td class="tg-0lax">
                            <img class="partner" src="/images/partner1.png" alt="why-jem-shocks" />
                            </td>
                            <td class="tg-0lax">
                            <img class="partner" src="/images/partner2.png" alt="why-jem-shocks" />
                            </td>
                            <td class="tg-0lax">
                            <img class="partner" src="/images/partner3.png" alt="why-jem-shocks" />
                            </td>
                            <td class="tg-0lax">
                            <img class="partner" src="/images/partner4.png" alt="why-jem-shocks" />
                            </td>
                            <td class="tg-0lax">
                            <img class="partner" src="/images/partner5.png" alt="why-jem-shocks" />
                            </td>
                        </tr>
                    </tbody>
                </table>
